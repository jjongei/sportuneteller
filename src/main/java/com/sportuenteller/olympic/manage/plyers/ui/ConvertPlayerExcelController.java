...
import com.sportuenteller.olympic.manage.plyers.application.convert.ConvertPlayerExcelService;
...
public class ConvertPlayerExcelController {
    @Autowired
    ConvertPlayerExcelService service;
    @Autowired
    View downloadView;
    ...
    String postUpload(@RequestParam("files") MultipartFile[] mFiles){
        ...
        try {
            ...
            throw new FileNotUploadException(e, "Player list excel file");
        }
        service.upload(file);
    ...
    ModelAndView getDownload(Model model){
        ...
        mav.addObject("downloadFileName", "Player("+Long.toString(System.nanoTime())+").xlsx");
